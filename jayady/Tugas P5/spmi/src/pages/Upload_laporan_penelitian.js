...
function Upload_laporan_penelitian() {
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-2xl font-bold mb-4">Upload Laporan Penelitian</h1>
            ...
            <h2 className="text-xl font-semibold mb-2">Daftar Laporan Terupload</h2>
...
export default Upload_laporan_penelitian;
